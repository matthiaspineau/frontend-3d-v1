<template>
  <div style="width: 100%; height: 100%; margin: 0; border: 0; padding: 0;">
    ...
    <canvas v-if="suportWebGL" ref="canvas" style="width: 100%; height: 100%;" :data-sizing="ajout"></canvas>
    <div v-else>
      <slot>
...
export default {
  ...
  methods: {
    ...
    addObject(object) {
      ...
      this.updateModel();
      // ------------------------
      // this.ajout = JSON.stringify(getSize(object))
        // this.ajout = getSize(object).x
      // ---------------------------
    },
    animate() {
